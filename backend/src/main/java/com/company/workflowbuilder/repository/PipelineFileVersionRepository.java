...
public interface PipelineFileVersionRepository extends JpaRepository<PipelineFileVersion,UUID>{
    List<PipelineFileVersion> findByPipelineIdAndSourceAliasOrderByVersionNumberDesc(UUID pipelineId,String sourceAlias);
