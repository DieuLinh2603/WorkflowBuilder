...
@Entity
@Table(name = "workflow_data_bindings")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class WorkflowDataBinding {
    @Id
    ...
    @Builder.Default
    private String triggerMode = "AUTO_ON_DATASET_SUCCESS";
    ...
    @Column(name = "last_consumed_version", nullable = false)
    private int lastConsumedVersion;
